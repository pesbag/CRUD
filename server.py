...
def return_shape_by_id(id:int):
    logger.info("enter to return_shape_by_id in web server")
...
def delete_shape(id:int):
    logger.info("enter to delete_shapes in web server")
...
async def create_new_shape(data: dict):
    logger.info("enter to create_new_shape in web server")
...
def change_params(id:int,data:dict):
     logger.info("enter to change_params in web server")
